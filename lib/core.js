...
module.exports = (boot) => {
        ...
        '__assign', 'const', ast0.code(ast0.lookup('__self'),
            ['target', 'source'], ['out', 'const'], '', ast0.meta(
                (pass, instance) => {
                    ...
                    return ast1.metaOut(
                        (pass, func, target) => {
                            func.add(ast2.native({
                                js: '__self.target = __self.source',
                                c: '',
                            }));
                        },
                        type.basic('null')
    ...
    //                         {
    //                             js: (pass, target) => {
    //                                 // TODO // pass.write(target('__self.get(\'val1\') + __self.get(\'val2\')'));
    //                             }
    //                         },
    //                         type.basic('int')
    //                     )
    ...
    //                     {
    //                         js: (pass, target) => {
    //                             // TODO // pass.write(target('+__self.get(\'val\')'));
    //                         }
    //                     },
    ...
    //                     {
    //                         js: (pass, target) => {
    //                             // TODO // pass.write("let str = __self.get(\'val\').toString()");
    //                             // TODO // pass.write(target("parseInt(str.substr(0, (str.indexOf('.') < 0) ? (str.length) : str.indexOf('.') ))"));
    //                         }
    //                     },
    //                     type.basic('int')
    //                 )
    ...
    //                         {
    //                             js: (pass, target) => {
    //                                 // TODO // pass.writeRaw('    if (!__self.get("c")) {');
    //                                 // TODO // pass.writeRaw('        __self.__func = null;');
    //                                 // TODO // pass.writeRaw('        __self.__caller.__func();');
    //                                 // TODO // pass.writeRaw('        return;')
    //                                 // TODO // pass.writeRaw('    }');
    //                             }
    //                         }
    //                     )
    ...
    //                     {
    //                         js: (pass, target) => {
    //                             // TODO // pass.write('__self.__caller.__func = null');
    //                             // TODO // pass.write('__self.__caller.__caller.__func()');
    //                         }
    //                     }
    //                 )
    //             },
